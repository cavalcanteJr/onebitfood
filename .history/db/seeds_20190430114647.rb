...
r = Restaurant.create!(
  name: 'La Pergolettssão é estabei',
  description: 'Nossa milecer relações comerciais benéficas com diversos fornecedores que compartilham nosso compromisso com o atendimento ao cliente, qualidade e preços competitivos.',
